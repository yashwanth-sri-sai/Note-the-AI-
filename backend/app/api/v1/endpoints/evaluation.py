...
def get_latest_benchmark(current_user: User = Depends(get_current_user)):
...
def get_latest_quality_score(current_user: User = Depends(get_current_user)):
...
def get_benchmark_history(current_user: User = Depends(get_current_user)):
